...
class MwAN_full(nn.Module): # param: 16821760
    def __init__(self, option,embedding_matrix):
        super(MwAN_full, self).__init__()
        self.opts=option
        self.drop_out=option["dropout"]
        self.embedding = nn.Embedding(self.opts["vocab_size"] + 1, embedding_dim=self.opts["emb_size"])
       ...
       """
        ...
        prediction layer
        """
        self.prediction_layer=Pred_Layer(option)
